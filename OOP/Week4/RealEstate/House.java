...
public class House extends Residential {
    ...
    public House(String sa, int zi, double lp, double appa, int bec, double bac, int sfa, double ya){
        super(sa, zi, lp, appa, bec, bac, sfa);
        yardAcres = ya;
    }
    ...
    public String toString(){
        ...
        String line2Pt1 = String.format("Residence Type: House");
